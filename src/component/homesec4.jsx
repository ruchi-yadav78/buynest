    ...
    return (
        <div className='homesec4main'>
            <div className="twobanner">
                <div className="snackbn" data-aos="fade-right">
                ...
                <div className="snackbn2" data-aos="fade-left">
                    <div className="snackbninfo">
            ...
            <div className="fourcopan">
                <div className="copan1" data-aos="fade-right">
                    <i className="fa-solid fa-truck"></i>
                    <h4>Free Shipping</h4>
                    <h6>Free shipping on all US order or order above $200</h6>
                </div>
                <div className="copan1" data-aos="fade-down">
                    <i className="fa-light fa-hand-holding-seedling"></i>
                    <h4>24X7 Support</h4>
                    <h6>Contact us 24 hours a day, 7 days a week</h6>
                </div>
                <div className="copan1" data-aos="fade-up">
                    <i className="fa-light fa-badge-percent"></i>
                    <h4>30 Days Return</h4>
                    <h6>Simply return it within 30 days for an exchange</h6>
                </div>
                <div className="copan1" data-aos="fade-left">
                    <i className="fa-light fa-circle-dollar-to-slot"></i>
                    <h4>Payment Secure</h4>
                    <h6>Contact us 24 hours a day, 7 days a week</h6>
                </div>
            </div>
            <div className="blogsec">
                <div className="deal">Latest  <span>Blog</span></div>
                <div className="proddata">We tackle interesting topics every day in 2023.</div>

                <div className="fourblog" data-aos="flip-up">
                    <div className="blog1">
                        <div className="blog1img"><img src={blog1} alt="" /></div>
                        <span>June 30,2022 - Organic</span>
                        <h5>Marketing Guide: 5 Steps to Success to way.</h5>
                        <h6>Read More <i className="fa-solid fa-angles-right"></i></h6>
                    </div>
                    <div className="blog1">
                    <div className="blog1img"><img src={blog2} alt="" /></div>
                        <span>April 02,2022 - Fruits</span>
                        <h5>Best way to solve business deal issue in market.</h5>
                        <h6>Read More <i className="fa-solid fa-angles-right"></i></h6>
                    </div>
                    <div className="blog1">
                    <div className="blog1img"><img src={blog3} alt="" /></div>
                        <span>Mar 09,2022 - Vegetables</span>
                        <h5>31 grocery customer service stats know in 2019.</h5>
                        <h6>Read More <i className="fa-solid fa-angles-right"></i></h6>
                    </div>
                    <div className="blog1">
                    <div className="blog1img"><img src={blog4} alt="" /></div>
                        <span>January 25,2022 - Fastfood</span>
                        <h5>Business ideas to grow your business traffic.</h5>
                        <h6>Read More <i className="fa-solid fa-angles-right"></i></h6>
                    </div>
                    <div className="blog1">
                    <div className="blog1img"><img src={blog5} alt="" /></div>
