  ...
  return (
    <div className='aboutmain'>
      ...
      <div className="absec1">
        ...
        <div className="svgsection" data-aos="zoom-in-up">
          <div className="abcounts">
          ...
          <div className="abcounts">
            ...
            <div className="abnum">60+
              <h5>Quality Products</h5>
            </div>
          </div>
        </div>
        <div className="blogtag">
          <div className="deal">Our  <span>Services</span></div>
          <div className="proddata">Customer service should not be a department. It should be the entire company.</div>
        </div>
        ...
        <div className="blogtag">
          <div className="deal">Our<span>Team</span></div>
          <div className="proddata">Meet out expert team members.</div>
        </div>
